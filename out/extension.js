...
const METHOD_DOCS = {
    ...
    autoLayout: 'AutoLayout helper to render content model records with a configured snippet/template.',
...
function activate(context) {
    ...
    if (vscode.window.activeTextEditor) {
        void maybeAssignWebengineExtensionlessFileToHtml(vscode.window.activeTextEditor.document).then((changed) => {
            if (!changed) {
    ...
    }), vscode.workspace.onDidSaveTextDocument((document) => runValidation(document)), vscode.workspace.onDidCloseTextDocument((document) => diagnostics.delete(document.uri)), vscode.workspace.onDidChangeTextDocument((event) => {
...
async function maybeAssignWebengineExtensionlessFileToHtml(document) {
